...
/// <summary>
/// 导管附魔：为卡牌添加「焊接」关键词（跨 mod 共用，见 GekitoLib.Weld）。
...
public class DaoGuan : CustomEnchantmentModel
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => [HoverTipFactory.FromKeyword(Weld.GekitoLibKeywords.Weld)];
    ...
    {
        return base.CanEnchant(card) && !card.Keywords.Contains(Weld.GekitoLibKeywords.Weld);
    }

    protected override void OnEnchant()
    {
        Card.AddKeyword(Weld.GekitoLibKeywords.Weld);
    }
}
